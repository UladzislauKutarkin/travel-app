...
const WidgetsBox = (props:any) => {
   ...
   const {currenc, localTime, humidity, feelsLike, days, months, wind, capital, ISOCode, currency, name}:any = props;
  ...
  return (
    <div className="widget_box">
      ...
      <CurrencyWidget  ISOCode = {ISOCode}  currency = {currency} name = {name} currenc = {currenc}/>
    </div>
  );
};
